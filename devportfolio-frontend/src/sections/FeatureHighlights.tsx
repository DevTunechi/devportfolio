      ...
      >
        {features.map((feature, index) => (
          <motion.div
            ...
            className={`relative rounded-2xl p-[2px] bg-gradient-to-br from-${feature.color}-500/50 via-${feature.color}-600/30 to-transparent shadow-[0_0_20px_-5px_${feature.color}-500/40]`}
          >
